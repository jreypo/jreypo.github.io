...
The recommended to perform a major version upgrade in VIO is still the vSphere Web Client, as I shown in [VIO upgrade post]({{< ref "posts/2015-10-21-upgrading-vmware-integrated-openstack.md" >}}), however using `viocli upgrade` the upgrade can also be performed from VIO Manager shell.
