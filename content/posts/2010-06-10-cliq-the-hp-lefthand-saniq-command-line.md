...
It seems that a very popular post, if not the most popular one, is the one about my [first experiences with the P4000 virtual storage appliance]({{< ref "posts/2010-04-09-first-hands-on-with-the-hp-lefthand-p4000-vsa.md" >}}) and because of that I decided to go deeper inside the VSA and the p4000 series and write about it.
...
[![CLIQ SSH access](/images/cliq_ssh1.jpg "CLIQ SSH access")](/images/cliq_ssh1.jpg)
...
[![](/images/cliq_local.jpg "CLIQ remote shell")]({{site.utl}}/assets/images/cliq_local.jpg)
