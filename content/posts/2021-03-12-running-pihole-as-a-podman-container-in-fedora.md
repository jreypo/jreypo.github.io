...
Configure [FirewallD](https://firewalld.org/) by adding rules to enable access to Pi-Hole TCP and UDP ports. If you want to know more about `firewalld` review my article [here]({{< ref "posts/2015-04-08-firewalld-quickstart-guide.md" >}}).
...
[![](/images/pi-hole.png)](/images/pi-hole.png)
...
[![](/images/cockpit-podman.png)](/images/cockpit-podman.png)
