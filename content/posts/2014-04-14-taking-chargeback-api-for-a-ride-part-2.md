...
In the [first post]({{< ref "posts/2014-04-03-taking-chargeback-api-for-a-ride-part-1.md" >}}) of the series we discussed Chargeback API basics and how to interact with it using Firefox REST Client. In this second and final post we will see how Chargeback integrates with **vCenter Orchestrator**.
...
[![](/images/add_cbm_server_vco.png "Chargeback server URL")](/images/add_cbm_server_vco.png)

A screen with the details of our Chargeback server will appear, click **Import** to accept the certificate.

[![](/images/vco_import_ssl_cert.png "Import SSL certificate")](/images/vco_import_ssl_cert.png)

Now from the **Chargeback (2.0.0)** area go to **New Server** tab, enter Chargeback server details and click **Apply Changes**.

[![](/images/vco_add_cbm_details.png "Enter Chargeback server details")](/images/vco_add_cbm_details.png)

In vCO client our new Chargeback server will appear.

[![](/images/cbm_vco_inventory.png "vCO inventory")](/images/cbm_vco_inventory.png)
...
[![](/images/vco_cbm_get_all_hierarchies.png "Get all hierarchies")](/images/vco_cbm_get_all_hierarchies.png)
...
[![](/images/cbm_wf_schema.png "Workflow schema")](/images/cbm_wf_schema.png)
...
[![](/images/cbm_list_hr_logs.png "Workflow logs")](/images/cbm_list_hr_logs.png)
...
[![](/images/cbm_actions_vco_api_explorer.png "Chargeback Actions")](/images/cbm_actions_vco_api_explorer.png)
...
[![](/images/vco_cbm_scripting_classes.png "Scripting Classes")](/images/vco_cbm_scripting_classes.png)
...
[![](/images/vco_rest_wfs.png "REST plugin workflows")](/images/vco_rest_wfs.png)
...
[![](/images/vco_add_rest_host.png "Add REST Host")](/images/vco_add_rest_host.png)

In the next two steps select Basic authentication mode…

[![](/images/vco_add_rest_host_auth.png "Select authentication")](/images/vco_add_rest_host_auth.png)

…shared session and enter Chargeback server credentials.

[![](/images/vco_rest_host_cbm_credentials.png "Chargeback server credentials")](/images/vco_rest_host_cbm_credentials.png)
...
[![](/images/vco_add_rest_op_login.png "Login")](/images/vco_add_rest_op_login.png)

### Logout

[![](/images/vco_add_rest_op_logout.png "Logout")](/images/vco_add_rest_op_logout.png)

### Create a new hierarchy

[![](/images/vco_add_rest_op_add_new_hierarchy.png "Create new hierarchy")](/images/vco_add_rest_op_add_new_hierarchy.png)

### Add a new Fixed Cost

[![](/images/vco_add_rest_op_add_fixed_cost.png "Add Fixed Cost")](/images/vco_add_rest_op_add_fixed_cost.png)

### Get task status

[![](/images/vco_add_rest_op_get_task_status.png "Get Task Status")](/images/vco_add_rest_op_get_task_status.png)
...
[![](/images/vco_rest_cbm_new_operations.png "New REST operations")](/images/vco_rest_cbm_new_operations.png)

Now we can proceed to create our workflows.

### Add a new Hierarchy to Chargeback

We are going to reproduce one the examples from [Part 1]({{< ref "posts/2014-04-03-taking-chargeback-api-for-a-ride-part-1.md" >}}) using vCO. First create a new empty workflow. As attributes we are going to use the following ones:
...
[![](/images/vco_rest_add_new_hr_attributes.png "Workflow attributes")](/images/vco_rest_add_new_hr_attributes.png)

Next configure the input parameters, basically for our purposes here we will need the hierarchy name description.

[![](/images/vco_rest_add_new_hr_parameters.png "Workflow parameters")](/images/vco_rest_add_new_hr_parameters.png)

At the presentation layer the parameters will shown as **Name of the new hierarchy** and **Description for the new hierarchy**.

[![](/images/vco_rest_add_new_hr_parameters_presentation.png "Presentation layer")](/images/vco_rest_add_new_hr_parameters_presentation.png)
...
[![](/images/vco_rest_add_new_hr_logs_failure.png)](/images/vco_rest_add_new_hr_logs_failure.png)
...
[![](/images/vco_rest_add_new_hr_rest_response_content.png "REST response")](/images/vco_rest_add_new_hr_rest_response_content.png)
...
[![](/images/vco_rest_add_new_hr_if_condition.png "Decision condition")](/images/vco_rest_add_new_hr_if_condition.png)
...
[![](/images/vco_rest_add_new_hr_bind_input_scripting_task.png "Bind input parameters")](/images/vco_rest_add_new_hr_bind_input_scripting_task.png)
...
[![](/images/vco_rest_add_new_hr_final_schema.png "Workflow final schema")](/images/vco_rest_add_new_hr_final_schema.png)

Launch it and enter a name and a description to test it.

[![](/images/vco_rest_add_new_hr_launch.png "Launch workflow")](/images/vco_rest_add_new_hr_launch.png)
...
[![](/images/vco_rest_add_new_hr_new_hr_cbm_ui.png "New CBM hierarchy created")](/images/vco_rest_add_new_hr_new_hr_cbm_ui.png)
...
[![](/images/vco_rest_add_new_fixed_cost_attributes.png "Add New Fixed cost workflow attributes")](/images/vco_rest_add_new_fixed_cost_attributes.png)
...
[![](/images/vco_rest_add_new_fixed_cost_input_parameters.png "Workflow input parameters")](/images/vco_rest_add_new_fixed_cost_input_parameters.png)
...
[![](/images/vco_rest_add_new_fixed_cost_input_parameters_presentation.png "Add new property")](/images/vco_rest_add_new_fixed_cost_input_parameters_presentation.png)
...
[![](/images/vco_rest_add_new_fixed_cost_bind_input_parameters.png "Bind input parameters")](/images/vco_rest_add_new_fixed_cost_bind_input_parameters.png)
...
[![](/images/vco_rest_add_new_fixed_cost_wf_execution.png "Add New Fixed Cost workflow execution")](/images/vco_rest_add_new_fixed_cost_wf_execution.png)

Check in the Chargeback UI our newly created Fixed Cost.

[![](/images/vco_rest_add_new_fixed_cost_cost_created_cbm_ui.png "New Fixed Cost created")](/images/vco_rest_add_new_fixed_cost_cost_created_cbm_ui.png)

We can also have a look at the API response in the workflow logs.

[![](/images/vco_rest_add_new_fixed_cost_wf_logs_api_response.png "API response")](/images/vco_rest_add_new_fixed_cost_wf_logs_api_response.png)
