...
In my previous [post]({{< ref "posts/2010-05-10-howto-identify-the-emc-lun-id-in-hp-ux-11iv3.md" >}}) about EMC storage I showed a procedure to identify the ID of LUN presented to an 11iv3 host without Powerpath, which is not recommended to be installed on 11.31. I stated that I only did test the procedure with Symmetrix DMX arrays.
