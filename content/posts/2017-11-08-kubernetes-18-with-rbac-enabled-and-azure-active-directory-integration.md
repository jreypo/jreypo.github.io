...
[![](/images/aad_k8s_1.png "New app registration")](/images/aad_k8s_1.png)

For the Server App:

[![](/images/aad_k8s_api.png "Server app creation")](/images/aad_k8s_api.png)

For the Client App:

[![](/images/aad_k8s_native.png "Client app creation")](/images/aad_k8s_native.png)
...
[![](/images/aad_k8s_native_permissions_1.png "Client app permissions")](/images/aad_k8s_native_permissions_1.png)

Click *Add*, select the Server Application in *Select an API* section and enable the access permissions.

[![](/images/aad_k8s_native_permissions_2.png "Client app permissions")](/images/aad_k8s_native_permissions_2.png)
...
[![](/images/aad_k8s_kubectl_auth.png "Kubectl authentication through AAD")](/images/aad_k8s_kubectl_auth.png)
