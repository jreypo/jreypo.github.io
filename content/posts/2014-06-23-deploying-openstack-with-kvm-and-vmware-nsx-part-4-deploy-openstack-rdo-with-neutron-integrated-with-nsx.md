...
Welcome to Part 4 for this series about OpenStack and VMware NSX. To do a quick review, in the first three parts we described the different [VMware NSX components and concepts]({{< ref "posts/2014-04-29-deploying-openstack-with-kvm-and-vmware-nsx-part-1-nsx-overview-and-initial-setup.md" >}}) and [how to install and configure them]({{< ref "posts/2014-05-06-deploying-openstack-with-kvm-and-vmware-nsx-part-2-configure-nsx-transport-and-logical-network-views.md" >}}), also discussed how to install and [configure the KVM and GlusterFS nodes]({{< ref "posts/2014-05-07-deploying-openstack-with-kvm-and-vmware-nsx-part-3-kvm-hypervisor-and-gluster-storage-setup.md" >}}). In this fourth part of the series we will see how to deploy OpenStack in a three-node architecture and integrate it with our existent NSX installation.
...
In the Neutron node install NSX Open vSwitch version as described in [Part 3]({{< ref "posts/2014-05-07-deploying-openstack-with-kvm-and-vmware-nsx-part-3-kvm-hypervisor-and-gluster-storage-setup.md" >}}) for the KVM nodes, the network interface configuration it's quite similar.
...
[![](/images/screen-shot-2014-06-17-at-01-56-04.png)](/images/screen-shot-2014-06-17-at-01-56-04.png)
...
[![](/images/screen-shot-2014-06-21-at-22-15-20.png)](/images/screen-shot-2014-06-21-at-22-15-20.png)
