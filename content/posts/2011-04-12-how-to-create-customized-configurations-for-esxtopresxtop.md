...
[![](/images/resxtop1.png "resxtop")](/images/resxtop1.png)
...
[![](/images/esxtop_edit_fields2.png "Edit esxtop fields")](/images/esxtop_edit_fields2.png)
...
[![](/images/memory.png "esxtop memory view")](/images/memory.png)
...
[![](/images/save_custom_file.png "Save esxtop config to file")](/images/save_custom_file.png)

Exit `esxtop` and run it again but loading the saved config file, instead of the default one, by using `-c <config_file>`.

[![](/images/load_custom_config.png "Load esxtop custom config file")](/images/load_custom_config.png)
