...
[![](/images/vcsa_summary.png "vCSA Summary")](/images/vcsa_summary.png)
...
[![](/images/vcsa_config_file.png "vCSA configuration file")](/images/vcsa_config_file.png)
...
[![](/images/vcsa_upload_sysprep_files.png "Upload Sysprep files")](/images/vcsa_upload_sysprep_files.png)

A new windows will open, select the operating system and browse for the location of the files.

[![](/images/sysprep_files_upload_screen.png "Select Sysprep files OS")](/images/sysprep_files_upload_screen.png)
...
[![](/images/vcsa_vc_services.png "vCenter Services")](/images/vcsa_vc_services.png)

The **SSO section**. Here you can configure all the settings related to the newly introduced Single Sign On server.

[![](/images/vcsa_sso_settings.png "vCSA SSO settings")](/images/vcsa_sso_settings.png)
