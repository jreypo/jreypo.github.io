...
In the [first article]({{< ref "posts/2025-09-10-exposing-aks-workloads-on-azure-2025-edition.md" >}}) we walked through the different ways you can expose workloads running in AKS. Then in the [second article]({{< ref "posts/2025-09-19-a-deep-dive-into-the-kubernetes-gateway-api.md" >}}) we went deep into the new Kubernetes Gateway API and what it means for AKS.
