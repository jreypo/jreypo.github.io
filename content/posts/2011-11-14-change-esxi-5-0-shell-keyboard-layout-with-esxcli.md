...
[![](/images/esxi_key_layout.png "Get current layout")](/images/esxi_key_layout.png)
...
[![](/images/esx_avail_layouts.png "List available layouts")](/images/esx_avail_layouts.png)

## Change keyboard layout

The syntax for the command can be retrieved by appending `–help` to the command.

[![](/images/esxicli_key_help.png)](/images/esxicli_key_help.png)

Now change the layout to `US Default`.

[![](/images/esxcli_change_key_layout.png "Change ESXi keyboard layout")](/images/esxcli_change_key_layout.png)
...
[![](/images/change_esxi_key_layout_nopersist.png)](/images/change_esxi_key_layout_nopersist.png)
