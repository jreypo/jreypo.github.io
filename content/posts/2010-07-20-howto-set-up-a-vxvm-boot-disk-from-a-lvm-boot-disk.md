...
I'm going to take for granted that all of you understand the basic structure of boot disks on Itanium servers. If you have read my [post]({{< ref "posts/2010-06-24-boot-disk-structure-on-integrity-servers.md" >}} ) about boot disk structure on Integrity servers you will remember that the disks are composed by three partitions:
