...
Cockpit is a remote management interface of Linux hosts, I have written before about Cockpit [here]({{< ref "posts/2015-01-08-managing-your-fedora-server-with-cockpit.md" >}}), [here]({{< ref "posts/2015-01-09-how-to-install-cockpit-on-centos-7.md" >}}) and [here]({{< ref "posts/2016-01-12-you-can-run-cockpit-in-photon-os.md" >}}). In an Atomic Host, Cockpit can be used to manage docker containers and Kubernetes clusters.
