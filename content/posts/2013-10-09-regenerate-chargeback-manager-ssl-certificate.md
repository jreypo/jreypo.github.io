...
[![](/images/cbm_generate_ssl.png "CBM_generate_SSL")](/images/cbm_generate_ssl.png)
...
[![](/images/gen_ssl_bat_file.png)](/images/gen_ssl_bat_file.png)

Edit the file using your favorite text editor, in my case I’m using Notepad++, and go to line number 72 as in the capture.

[![](/images/generate_ssl_certificate_bat.png)](/images/generate_ssl_certificate_bat.png)
...
[![](/images/bat_ssl_execution.png)](/images/bat_ssl_execution.png)

After that it will generate the new certificate and will start Load Balancer services.

[![](/images/ssl_bat_execution_done.png)](/images/ssl_bat_execution_done.png)
