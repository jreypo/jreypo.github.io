...
These steps apply to **Azure DevOps Server 2020+**, if you remember from my [previous article]({{< ref "posts/2025-04-28-level-up-your-homelab-autoamtion-with-azure-devops-server.md" >}}) I am running Azure DevOps Server 2022 in my homelab.
...
[![Variable Groups](/images/ado-variable-group.png)](/images/ado-variable-group.png)
