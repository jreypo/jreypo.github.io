...
After the [previous article]({{< ref "posts/2013-10-09-regenerate-chargeback-manager-ssl-certificate.md" >}}) about SSL certificate generation in Chargeback I decided that it was worth to write a couple more tips in a second blog post. This is not a “how to install…” or “how to configure…” post. There are other bloggers in the community that have written about it before so I believe there is no point on repeating the same.
...
[![](/images/cbm_db_config.png "Chargeback database configuration")](/images/cbm_db_config.png)
...
[![](/images/cbm_vc_conifig.png "vCenter database URL")](/images/cbm_vc_conifig.png)
