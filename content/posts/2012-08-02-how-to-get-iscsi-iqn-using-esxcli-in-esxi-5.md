...
Back in 2010 I wrote a post about [how to get the iSCSI iqn of an ESXi 4.x]({{< ref "posts/2010-12-13-get-the-iscsi-iqn-of-an-esxi-using-the-cli.md" >}}) server using vSphere CLI from the vMA or any other system with vCLI installed on it.
...
[![](/images/esxcli_list_hbas.png "List host HBAs")](/images/esxcli_list_hbas.png)

Next we get the info of the adapter.

[![](/images/get_adapter_info_esxcli.png "Get adapter information")](/images/get_adapter_info_esxcli.png)
