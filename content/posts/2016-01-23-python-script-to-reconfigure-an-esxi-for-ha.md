...
If you have following my blog for some time you may remember a [post from 2011]({{< ref "posts/2011-02-21-reconfigure-a-esxi-for-ha-using-vsphere-powercli.md" >}}) where I wrote about the procedure perform a **Reconfigure for HA** operation in an ESXi host from PowerCLI command line, I even published a small and dirty script to do it in one command. I've been thinking for some time to convert to Python that and many other vSphere scripts I have in PowerCLI and Perl and finally I decide to do it and this is the first result.
