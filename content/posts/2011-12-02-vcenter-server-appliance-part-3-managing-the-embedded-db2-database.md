...
[![](/images/check_db2_version.png "Check DB2 installed version")](/images/check_db2_version.png)

Now that we now it is DB2 Express version 9.7.2-1, list the files in the package.

[![](/images/list_db2_rpm_files.png "List DB2 rpm files")](/images/list_db2_rpm_files.png)
...
[![](/images/opt_db2_directory.png "/opt/db2 directory contents")](/images/opt_db2_directory.png)
...
[![](/images/logs_symlink.png)](/images/logs_symlink.png)
...
[![](/images/check_db2_processes.png "Check DB2 processes")](/images/check_db2_processes.png)
...
[![](/images/db2_users.png "DB2 users")](/images/db2_users.png)
...
[![](/images/dbls2_command.png)](/images/dbls2_command.png)
...
[![](/images/check_db2_db_manager.png "Check DB2 database manager")](/images/check_db2_db_manager.png)

Try to stop the manager with `db2stop`.

[![](/images/db2stop_fails.png)](/images/db2stop_fails.png)

Since the vCenter database is active the operation is not allowed, to force the stop use `db2stop force`.

[![](/images/stop_db2_db_manager.png "Stop DB2 database manager")](/images/stop_db2_db_manager.png)

Then start again the database manager.

[![](/images/start_db2_db_manager.png "Start DB2 database manager")](/images/start_db2_db_manager.png)
...
[![](/images/get_db2_instance.png "Get DB2 instance")](/images/get_db2_instance.png)
...
[![](/images/get_db2_directory_details.png "List created DB's")](/images/get_db2_directory_details.png)
...
[![](/images/list_active_databases.png "List active databases")](/images/list_active_databases.png)

Open a connection to the database and retrieve connection state.

[![](/images/get_db_connection_state.png "Get database connection state")](/images/get_db_connection_state.png)
...
[![](/images/get_vcdb_config.png "Get VCDB database configuration")](/images/get_vcdb_config.png)

List the `tablespaces` of the database.

[![](/images/list_db_tablespaces.png "List database tablespaces")](/images/list_db_tablespaces.png)
...
[![](/images/get_vc_user_password.png "Get vc user password")](/images/get_vc_user_password.png)
...
[![](/images/open_connection_to_db2.png "Open connection to database")](/images/open_connection_to_db2.png)
...
[![](/images/vcdb_db2_sql_script.png "VCDB DB2 SQL script from Windows vCenter")](/images/vcdb_db2_sql_script.png)
...
[![](/images/get_vpxproduct_vpxversion_tables.png "Get vpx_product and vpx_version tables")](/images/get_vpxproduct_vpxversion_tables.png)

Get the virtual datacenter ID, contained in the `vpx_datacenter` table.

[![](/images/get_virtual_dc_id.png "Get Virtual Datacenter ID")](/images/get_virtual_dc_id.png)

### db2 command line processor

Make yourself `db2inst1` user and launch the `db2` shell.

[![](/images/launch_db2_shell.png "Launch db2 shell")](/images/launch_db2_shell.png)
...
[![](/images/vc_tables_prefix.png "Prefix tables with owner, vc")](/images/vc_tables_prefix.png)

Or set the schema at the beginning.

[![](/images/set_db_schema.png "Set DB schema for operations")](/images/set_db_schema.png)
